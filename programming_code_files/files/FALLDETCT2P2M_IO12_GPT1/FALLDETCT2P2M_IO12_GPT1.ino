...
void setup() {
  ...
  hu.configLEDLight(hu.eFALLLed, 0); // FALL LED OFF by default
  ...
  // Report current config over Serial
  ...
  // --- Hardware IO setup with internal pull‑downs ---
  pinMode(FALL_PIN,     INPUT_PULLDOWN);
